...
import { Percent, HeartFill, ArrowThroughHeart, ArrowThroughHeartFill, StarFill, StarHalf, Star } from "react-bootstrap-icons";

import Ctx from "../context"

const Product = ({img, name, price,_id, discount,tags, likes}) => {
    const {
        userId,
        token,
        setServerGoods,
            ...
            {product?.name ? <>
                ...
                {product?.discount > 0 &&
                    <div className="product__price">
                        ...
                        <span style={{fontSize:"22px"}}>{product.discount > 0
              ?<>
 ...
 <button className="product__cart__btn" onClick={addToCart} disabled={inBasket}>В корзину</button>
                ...
                <div className="product__add__favorites" onClick={updLike}>{isLike ? <ArrowThroughHeartFill/> : <ArrowThroughHeart/>} В избранное</div>
